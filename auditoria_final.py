...
MANIFEST = BASE / 'output' / 'manifest_unificado_final.csv'
CHECKPOINT = BASE / 'output' / 'best_stgcn_canonico.pth'
...
class TestDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        x = np.load(str(BASE / self.paths[idx].replace('\\', '/')))
        y = self.labels[idx]
...
def main() -> None:
    ...
    out_csv = BASE / 'output' / 'auditoria_final_test.csv'
