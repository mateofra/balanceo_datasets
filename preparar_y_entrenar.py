...
for epoch in range(50):
    ...
    if val_acc > best_val:
        ...
        }, BASE / 'output/best_stgcn_canonico.pth')

# ── 5. Evaluación final en test bloqueado ────────────────────────────────
ckpt = torch.load(BASE / 'output/best_stgcn_canonico.pth', map_location=device)
...
with open(BASE / 'output/training_history_canonico.json', 'w', encoding='utf-8') as f:
    json.dump({
        'history': history,
