...
IMG_DIR  = BASE / 'datasets/hagrid_raw/hagrid-sample-30k-384p'
OUT_DIR  = BASE / 'data/processed/landmarks/hagrid_nuevo'
LOG_PATH = BASE / 'output/extraccion_hagrid_nuevo.json'
MODEL_PATH = BASE / 'models/hand_landmarker.task'
