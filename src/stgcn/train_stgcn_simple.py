...
Parte de output/train_manifest_stgcn.csv, genera un split canónico reproducible
si el manifiesto no trae val/test, y entrena con balance por etiqueta + MST.
"""
...
def main():
    ...
    print("\n🧠 Creando modelo...")
    model = SimpleST_GCN(num_classes=len(label_order), hidden_dim=64).to(device)
