...
from src.preprocessing.landmarks_normalizer import LandmarkNormalizer
...
def main():
    manifest_path = str(REPO_ROOT / "data/processed/secuencias_stgcn/manifest_secuencias.csv")
    normalizer_path = str(REPO_ROOT / "src/preprocessing/landmarks_normalizer.json")
    ...
    from src.stgcn.st_gcn_dataloader_legacy import create_dataloaders
