...
MOVES = [
    ...
    ("diagnosticar_normalizacion.py", "src/scripts/diagnosis/"),
    ("diagnose_paths.py", "src/scripts/diagnosis/"),
    ("diagnostico_normalizacion.json", "src/scripts/diagnosis/"),
    ("verificar_landmarks.py", "src/scripts/diagnosis/"),
    ("verificar_secuencias.py", "src/scripts/diagnosis/"),
    
    # Scripts de entrenamiento
    ("generar_secuencias_stgcn.py", "src/scripts/training/"),
    ("visualizar_pipeline.py", "src/scripts/training/"),
    ("train_stgcn.py", "src/scripts/training/"),
    
    # Scripts de reparación
    ("repair_manifest.py", "src/scripts/repair/"),
    ("check_npy_shape.py", "src/scripts/repair/"),
    
    # Scripts de generación
    ("generar_graficos_balanceo.py", "src/scripts/generate/"),
    ("REPORTE_COMPLETITUD.py", "src/scripts/generate/"),
]
