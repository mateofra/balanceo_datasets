...
OUT_DIR = REPO_ROOT / 'output/graficas_informe'
...
# ════════════════════════════════════════════════════════════════════════
df = pd.read_csv(REPO_ROOT / 'output/manifest_unificado_final.csv')
...
manifest_fuente = REPO_ROOT / 'data/processed/secuencias_stgcn/manifest_secuencias.csv'
...
# ════════════════════════════════════════════════════════════════════════
seq_ejemplo = list((REPO_ROOT / 'data/processed/secuencias_stgcn').rglob('*.npy'))[0]
...
# ════════════════════════════════════════════════════════════════════════
with open(REPO_ROOT / 'output/training_history_canonico.json') as f:
    hist = json.load(f)
...
# ════════════════════════════════════════════════════════════════════════
df_audit = pd.read_csv(REPO_ROOT / 'output/auditoria_final_test.csv')
