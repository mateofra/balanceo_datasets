...
PATH_ORIGINAL = REPO_ROOT / 'output/manifest_canonico.csv'
PATH_NUEVO = REPO_ROOT / 'output/manifest_hagrid_nuevo_secuencias.csv'
PATH_SALIDA = REPO_ROOT / 'output/manifest_unificado_final.csv'
